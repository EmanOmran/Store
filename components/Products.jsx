        ...
        <div>
            <div className="container products">
                ...
                <div className="control-buttons">
                    <button type="button" className="btn btn-secondary mx-1" onClick={() => { filterData('all') }}> All</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('laptop') }}>Laptops</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('mobile') }}>Mobiles</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('makeup') }}>Makeup</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('clothes') }}>Clothes</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('Watches') }}>Watches</button>
                    <button type="button" className="btn btn-warning mx-1" onClick={() => { filterData('shoes') }}>Shoes</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('jewelry') }}>Jewelry</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('perfumes') }}>Perfumes</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('glasses') }}>Glasses</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('housewares') }}>Housewares</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('supermarket') }}>Supermarket</button>
                    <button type="button" className="btn btn-warning mx-1 mt-1" onClick={() => { filterData('health') }}>Health 
                    </button>
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-5" key={value.id}>
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <a className="btn btn-primary" onClick={increase}>Add To Card</a>
