                ...
                <div className="row">
                        ...
                        <div className="content">
                                ...
                                <ul className="text-light">
                                    <li> <FontAwesomeIcon icon={faMapMarkerAlt} className="fontawsome" /> 123 Consectetur at ligula 10660 </li>
                                    <li> <FontAwesomeIcon icon={faPhone} className="fontawsome" /> 010-020-0340</li>
                                    <li> <FontAwesomeIcon icon={faEnvelope} className="fontawsome" /> info@company.com</li>
                                </ul>
                                </div>
                 </div>
                 <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
